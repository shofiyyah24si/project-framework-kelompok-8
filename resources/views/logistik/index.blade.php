            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Monitoring logistik bencana berdasarkan ketersediaan
                    </p>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    <form method="GET" action="{{ route('logistik.index') }}">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Cari nama barang, sumber, satuan...">
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-lg-2">
                                <label class="form-label fw-medium text-dark mb-1">Status Stok</label>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100 border-0 shadow-sm">
                                ...
                                <div class="card-body py-2 px-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-start">
                                                <i class="bi bi-boxes text-muted mt-1 me-2"></i>
                                                <div>
                                                    <p class="mb-0 fw-medium text-dark">Jumlah Stok</p>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-start">
                                            <i class="bi bi-building text-muted mt-1 me-2"></i>
                                            <div>
                                                <p class="mb-0 text-dark fw-medium">Sumber</p>
                                                <small class="text-muted">
                                                    {{ $item->sumber ?? 'Tidak diketahui' }}
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                <p class="mb-0 text-dark fw-medium">Kejadian Bencana</p>
                                                <small class="text-muted">
                                                    @if($item->kejadian)
                                                        {{ $item->kejadian->jenis_bencana ?? '-' }}
                                                        @if($item->kejadian->lokasi_text)
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 fw-bold">Stok Aman</h6>
                                        <p class="text-muted small mb-0">Stok > 50</p>
                                    </div>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0 fw-bold">Stok Terbatas</h6>
                                        <p class="text-muted small mb-0">Stok 11-50</p>
                                    </div>
                                    <div class="fs-4 fw-bold text-info">
                                        {{ $data->whereBetween('stok', [11, 50])->count() }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted small mb-0">Stok 1-10</p>
                                    </div>
                                    <div class="fs-4 fw-bold text-warning">
                                        {{ $data->whereBetween('stok', [1, 10])->count() }}
                                    </div>
                                </div>
                            </div>
                        </div>
