    ...
    <div class="app-topstrip bg-dark py-6 px-3 w-100 d-lg-flex align-items-center justify-content-between">
      <div class="d-flex align-items-center justify-content-center gap-5 mb-2 mb-lg-0">
        <a class="d-flex justify-content-center" href="#">
          <img src="{{ asset('assets-admin/images/logos/logo-wrappixel.svg') }}" alt="" width="150">
        </a>
          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu">Donasi Bencana</span>
                </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"  
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Logistik Bencana</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"  
                    ...
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <span class="hide-menu">Distribusi Logistik</span>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-forms.html" aria-expanded="false">
                <i class="ti ti-file-text"></i>
                <span class="hide-menu">Forms Kejadian Bencana</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  <img src="{{ asset('assets-admin/images/profile/sofia.png') }}" alt="" width="35" height="35" class="rounded-circle">
                </a>
                    ...
                    <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="px-0">
                            <div class="d-flex align-items-center">
                              <img src="{{ asset('assets-admin/images/profile/user-8.jpg') }}" class="rounded-circle" width="40"
                                alt="flexy" />
                              <div class="ms-3">
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable mb-2 common-widget" style="height: 465px" data-simplebar="">
                  ...
                  <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                    <div>
                      <span><img src="{{ asset('assets-admin/images/profile/ale.png') }}" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                  ...
                  <div class="d-flex flex-row comment-row border-bottom active p-3 gap-3">
                    <div>
                      <span><img src="{{ asset('assets-admin/images/profile/piw.png') }}" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                  ...
                  <div class="d-flex flex-row comment-row border-bottom p-3 gap-3">
                    <div>
                      <span><img src="{{ asset('assets-admin/images/profile/phar.png') }}" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                    <div class="comment-text w-100">
                  ...
                  <div class="d-flex flex-row comment-row p-3 gap-3">
                    <div>
                      <span><img src="{{ asset('assets-admin/images/profile/jaa.png') }}" class="rounded-circle" alt="user"
                          width="50" /></span>
                    </div>
                    <div class="comment-text w-100">
