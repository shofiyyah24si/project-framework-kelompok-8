...
@section('content')
<h1 class="text-2xl font-semibold mb-4">Tambah Warga</h1>
<p class="text-xs text-slate-400 mb-6">Isi data warga secara lengkap untuk keperluan pendataan.</p>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="nama" value="{{ old('nama') }}"
                   class="w-full rounded-xl border border-slate-700 bg-slate-900/60 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-1 focus:ring-accent">
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="alamat" rows="3"
                      class="w-full rounded-xl border border-slate-700 bg-slate-900/60 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-1 focus:ring-accent">{{ old('alamat') }}</textarea>
        </div>
